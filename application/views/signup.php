              ...
              <div class="login-panel panel panel-success">
                  ...
                  if($error_msg){
                   ...
                   ?>
                      ...
                      <form role="form" method="post" action="<?php echo base_url('index.php/register_user'); ?>">
                          <fieldset>
                      ...
                      <center><b>You have Already registered ?</b> <br></b><a href="<?php echo base_url('index.php/login_view'); ?>"> Please Login</a></center><!--for centered text-->
                  </div>
              </div>
          </div>
      </div>
